...
export function QuickLogCard({ areas, onSave, language = 'ar' }: Props) {
  ...
  return <View style={styles.card}>
    <View style={styles.heading}><View style={styles.icon}><Text style={styles.iconText}>＋</Text></View><View style={styles.headingCopy}><Text style={styles.title}>{copy.title}</Text><Text style={styles.subtitle}>{copy.subtitle}</Text></View></View>
...
const styles = StyleSheet.create({
  ...
  heading: { flexDirection: 'row-reverse', alignItems: 'center', gap: 10, marginBottom: 13 },
